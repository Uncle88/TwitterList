...
namespace TwitterList
{
    ...
    {
        public static readonly string Consumer_KEY = "<61jConoUfzvXhymCCJ4bZpyO3>";
        public static readonly string Consumer_SECRET = "<1i6Ms9nVZUKdkcw9PlXmXpGXRQCN0FEIYq2m3Ub7tAyNH6FC3q>";
        ...
        public static readonly string TWITTER_CALLBACK_URL = "http://mobile.twitter.com";
        public static readonly string TWITTER_GRAPH_URL = "https://api.twitter.com/1.1/account/verify_credentials.json";
        public static readonly string TWITTER_ACCESS_TOKEN = "857636306666520577-GFTsnBV2lBlmGQPmP4GLlZB3MRnNN4J";
